...
\begin{figure*}[h!]
    \begin{tabular}{cccc}
    \subfloat[Pretraining of PALs, dialog acts]{\includegraphics[width = 2.8in]{img/pals_pretrain_da.png}} &
    \subfloat[Pretraining of PALs, sentiment]{\includegraphics[width = 2.8in]{img/pals_pretrain_sent.png}} \\
    \subfloat[Fine-tuning of PALs, dialog acts]{\includegraphics[width = 2.8in]{img/pals_finetune_da.png}} &
    \subfloat[Fine-tuning of PALs, sentiment]{\includegraphics[width = 2.8in]{img/pals_finetune_sent.png}}\\
    \subfloat[Different attributes in batch, dialog acts]{\includegraphics[width = 2.8in]{img/segm_pals_da.png}} &
    \subfloat[Different attributes in batch, sentiment]{\includegraphics[width = 2.8in]{img/segm_pals_sent.png}}
    \end{tabular}
...
\end{tabular}
\caption{Example of dialogue with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Negative sentiment and inform dialogue act were set for the entire conversation.}
\label{tab:example_neg_inform_dialogue}
\end{table}
...
\end{tabular}
\caption{Example of dialogue with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Positive sentiment and direct dialogue act were set for the entire conversation.}
\label{tab:example_pos_direct_dialogue}
\end{table}
...
\end{tabular}
\caption{Not very sucessful but common dialogue with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Sentiment and dialogue act for bot responce were selected before each bot's turn.}
\label{tab:soup_example_dialogue}
\end{table}
