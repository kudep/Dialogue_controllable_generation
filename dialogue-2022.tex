...
\end{tabular}
\caption{Example of dialog with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Negative sentiment and inform dialog act were set for the entire conversation.}
...
\end{tabular}
\caption{Example of dialog with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Positive sentiment and direct dialog act were set for the entire conversation.}
...
\end{tabular}
\caption{Not very sucessful but common dialog with small DialoGPT model and PALs for sentiment and dialog act control, blended with weighted average. Sentiment and dialog act for bot responce were selected before each bot's turn.}
